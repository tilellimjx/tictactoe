"""Shared agent loop utilities for V2 pipeline agents."""
...
TOOL_RUN_CMD: dict = {
    ...
    "description": (
        ...
        "Use 'python' for Python scripts, 'npm' for Node/Jest commands. "
...
def _resolve_command(cmd: str) -> str:
    """Replace bare python/pytest/pip with current interpreter paths."""
    py = sys.executable
    replacements = [
