#!/usr/bin/env python3
"""Requirements generation agent for a Tic Tac Toe game.
...
REQUIREMENTS_FILE   Output path (default: requirements/requirements_opus.md).
"""
...
REQUIREMENTS_FILE = Path(os.environ.get("REQUIREMENTS_FILE", "requirements/requirements_opus.md"))
MAX_ITERATIONS = 20
...
def main() -> None:
    ...
    tools: list[dict] = [
        ...
        },
        {
            ...
            "description": "Save the completed requirements document to requirements.md.",
            "input_schema": {
                "type": "object",
                "properties": {
                    "content": {
    ...
    print("Tic Tac Toe — Requirements Agent")
    print("=" * 50)
